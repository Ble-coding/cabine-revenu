...
<app-layout>
    <template #header>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Modification des informations du rechargement {{mtn.id}}
        </h2>
    </template>
    <div class="py-12">
        ...
        <div class="w-full">
                <button class="ml-2 hover:bg-blue-700 text-white font-bold py-2 px-4 mb-1 rounded">
                    <inertia-link href="/rechargements/mtn">🔙</inertia-link>
                </button>
 ...
 <div class="shadow overflow-hidden sm:rounded-md">
          <div class="px-4 py-5 bg-white sm:p-6">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input v-model="mtnData.datere" type="date" name="datere" id="datere" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <!--<input type="text" name="fournisseur_id"  class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">-->
                 <select
                   ...
                   id="fournisseur_id"
                     v-model="mtnData.fournisseur_id"
                  >
        ...
        <!-- <div v-for="(acte, index) inmtnData.actes" v-bind:key="index"> -->
          <div class="grid mt-4 grid-cols-6 gap-6">
            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
              ...
              <input placeholder="Entrez le montant" v-model="mtnData.montant" type="text" name="montant" id="montant" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            ...
            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
              <label for="reseau" class="block text-sm font-medium text-gray-700">Réseau</label>
               ...
               <select class="block appearance-none w-full bg-white border border hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
                       id="reseau" v-model="mtnData.reseau">
              ...
              <input v-model="mtnData.nreference" type="text" name="nreference" id="nreference" placeholder="Entrez le numéro" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
...
props: {
    ...
    data() {
     ...
     methods: {
        submit() {
            this.$inertia.patch('/rechargements/mtn/' + this.mtnData.id, this.mtnData)
        },
    //        add() {
  ...
  supprimer() {
           ...
           { this.$inertia.delete('/rechargements/mtn/' + this.mtnData.id, this.mtnData);
           }else{return false;}
        },
    },
}
